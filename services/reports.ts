...
/**
 * ==============================
 * SEND INVOICE EMAIL TYPES
 * ==============================
 */

export type SendAdminInvoiceEmailParams = {
  orderId: string;
  restaurantId?: string;
  branchId?: string;
};

export type SendAdminInvoiceEmailResponse = {
  success: boolean;
  data?: any;
  message?: string;
};
...
export const sendAdminInvoiceEmail = async ({
  orderId,
  restaurantId,
  branchId,
}: SendAdminInvoiceEmailParams): Promise<SendAdminInvoiceEmailResponse> => {
