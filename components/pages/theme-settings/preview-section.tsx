...
const PreviewSection = () => {
    ...
    return (
        <div className="bg-white p-4 md:p-6 rounded-lg shadow-sm">
            <h3 className="text-base text-dark mb-[24px]">{themeSettings("preview")}</h3>
            <div className="space-y-4">
                <div className="w-[113px] h-[46px] bg-[#E5E5E5] flex items-center justify-center rounded">
                    <span className="text-gray-500 text-base font-semibold">{themeSettings("yourLogo")}</span>
                </div>
                <h1 className={`text-2xl md:text-[37px] ${arimo.className}`} style={{ color: '#00FF7B' }}>{themeSettings("previewTitle")}</h1>
